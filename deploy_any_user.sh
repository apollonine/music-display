#!/bin/bash
# Dynamic deployment script - works with any username

set -e

echo "🎵 Music Display Deployment"
echo "=========================="
...
if [ ! -d "$HOME_DIR" ]; then
    ...
    echo "   This script expects a standard Linux home directory structure"
    exit 1
fi

# Update system (will prompt for password if needed)
